...
void sorta_shuffle(void *arr, size_t n, size_t size, size_t sections)
{
    ...
    for(i = 0; i < sections; ++i){
        ...
        shuffle((size_t *)arr+(start*size), num, size);
    }
}
...
void shuffle(void *arr, size_t n, size_t size)
{
    ...
    for(i = 0; i < n-1; ++i){
        ...
        memcpy(swp, (size_t *)arr+(j*size), size);
        memcpy((size_t *)arr+(j*size), (size_t *)arr+(i*size), size);
        memcpy((size_t *)arr+(i*size), swp,          size);
    }
}
